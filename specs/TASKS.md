...
- [x] **3.3 Accounts Explorer** (list + detail, dense). *Done =* gate green; **design `[REVIEW]`**.
...
- [x] **6.2 Link to `trade_analysis.position_history`** + unmatched / open / history views. *Done =*
...
- [x] **7.2 Reports** — `categoryReport`, `cashFlow`, `netWorth`. *Done =* gate green; report math tested.

## Phase 8 — Dashboard
- [x] **8.1 Cockpit dashboard** — balances, cash flow, budget-vs-actual at a glance. *Done =* gate
